...
const WEAPONS = {
  ...
  knife:          { id:'knife',          name:'Knife',          damage:7,  durability:180, rarity:'C', price:60,   repairCost:22,  art:'knife'  },
  aluminum_sword: { id:'aluminum_sword', name:'Aluminum Sword', damage:9,  durability:180, rarity:'C', price:110,  repairCost:34,  art:'sword'  },
  cracked_dagger: { id:'cracked_dagger', name:'Cracked Dagger', damage:11, durability:90,  rarity:'U', price:180,  repairCost:40,  art:'knife',  power:'double' },
  rusty_katana:   { id:'rusty_katana',   name:'Rusty Katana',   damage:11, durability:150, rarity:'U', price:220,  repairCost:44,  art:'katana' },
  wood_spear:     { id:'wood_spear',     name:'Spear',          damage:12, durability:130, rarity:'U', price:210,  repairCost:44,  art:'spear',  power:'reach' },
  wooden_mace:    { id:'wooden_mace',    name:'Wooden Mace',    damage:15, durability:170, rarity:'U', price:300,  repairCost:55,  art:'sword',  power:'stun' },
  metal_sword:    { id:'metal_sword',    name:'Metal Sword',    damage:14, durability:200, rarity:'U', price:360,  repairCost:60,  art:'sword'  },
  reinforced_bow: { id:'reinforced_bow', name:'Reinforced Bow', damage:14, durability:145, rarity:'R', price:520,  repairCost:80,  art:'bow',    power:'reach' },
  spiked_spear:   { id:'spiked_spear',   name:'Spiked Spear',   damage:18, durability:150, rarity:'R', price:640,  repairCost:90,  art:'spear',  power:'reach' },
  steel_mace:     { id:'steel_mace',     name:'Steel Mace',     damage:19, durability:160, rarity:'R', price:760,  repairCost:100, art:'sword',  power:'stun' },
  steel_katana:   { id:'steel_katana',   name:'Steel Katana',   damage:18, durability:240, rarity:'R', price:880,  repairCost:120, art:'katana' },
  scythe:         { id:'scythe',         name:'Scythe',         damage:20, durability:160, rarity:'R', price:1050, repairCost:130, art:'spear',  power:'sweep' },
  reinforced_mace:{ id:'reinforced_mace',name:'Reinforced Mace',damage:23, durability:200, rarity:'E', price:1450, repairCost:180, art:'sword',  power:'stun' },
  double_dagger:  { id:'double_dagger',  name:'Double Dagger',  damage:13, durability:200, rarity:'E', price:1750, repairCost:170, art:'knife',  power:'double' },
  emerald_scythe: { id:'emerald_scythe', name:'Emerald Scythe', damage:26, durability:220, rarity:'E', price:2400, repairCost:240, art:'spear',  power:'poison' },
  pastors_blade:  { id:'pastors_blade',  name:"Master's Blade", damage:30, durability:240, rarity:'L', price:4200, repairCost:420, art:'katana', power:'lifesteal' },
};
